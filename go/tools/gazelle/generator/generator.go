...
func New(repoRoot, goPrefix, prefixRoot, buildFileName, buildTags string, external rules.ExternalResolver) (*Generator, error) {
	bctx := build.Default
	...
	return &Generator{
		...
		bctx:          bctx,
		g:             rules.NewGenerator(repoRoot, prefixRoot, goPrefix, external),
	}, nil
}
