...
func NewGenerator(repoRoot string,  prefixRoot string, goPrefix string, external ExternalResolver) Generator {
	var (
		...
		r = structuredResolver{goPrefix: goPrefix, prefixRoot: prefixRoot}
	)
